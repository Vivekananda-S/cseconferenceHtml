...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/Pages/Accomodation.html">Accomodation</a>
                  </li>
                  <li class="nav-item">
    ...
    <!-- Content -->
    <div class="container">
      <img src="/Images/UnderConstruction.jpg" class="img-fluid" alt="UnderConstruction">
    </div>
     <!-- Footter-->
